	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.create(1D, 0D, 1D, 0.375D, 1D, 0.375D);
				case NORTH :
					return VoxelShapes.create(0D, 0D, 0D, 0.625D, 1D, 0.625D);
				case WEST :
					return VoxelShapes.create(0D, 0D, 1D, 0.625D, 1D, 0.375D);
				case EAST :
					return VoxelShapes.create(1D, 0D, 0D, 0.375D, 1D, 0.625D);
				case UP :
					return VoxelShapes.create(0D, 1D, 0D, 0.625D, 0.375D, 1D);
				case DOWN :
					return VoxelShapes.create(0D, 0D, 1D, 0.625D, 0.625D, 0D);
			}
		}
