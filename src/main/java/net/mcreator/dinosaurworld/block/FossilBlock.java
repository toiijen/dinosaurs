...
public class FossilBlock extends DinosaurworldElements.ModElement {
	@ObjectHolder("dinosaurworld:fossil")
	public static final Block block = null;
	public FossilBlock(DinosaurworldElements instance) {
		super(instance, 1);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("fossil", "fossil", blockAt -> {
