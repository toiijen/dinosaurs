...
public class PlotrohBlock extends DinosaurworldElements.ModElement {
	@ObjectHolder("dinosaurworld:plotroh")
	public static final Block block = null;
	public PlotrohBlock(DinosaurworldElements instance) {
		super(instance, 20);
	}
