...
public class PlotstredBlock extends DinosaurworldElements.ModElement {
	@ObjectHolder("dinosaurworld:plotstred")
	public static final Block block = null;
	public PlotstredBlock(DinosaurworldElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 20f).lightValue(15));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("plotstred");
		}
