...
public class Plotroh2Block extends DinosaurworldElements.ModElement {
	@ObjectHolder("dinosaurworld:plotroh2")
	public static final Block block = null;
	public Plotroh2Block(DinosaurworldElements instance) {
		super(instance, 21);
	}
