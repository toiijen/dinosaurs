...
public class CycadwoodBlock extends DinosaurworldElements.ModElement {
	@ObjectHolder("dinosaurworld:cycadwood")
	public static final Block block = null;
	public CycadwoodBlock(DinosaurworldElements instance) {
		super(instance, 5);
	}
