...
public class Plotvrhroh2Block extends DinosaurworldElements.ModElement {
	@ObjectHolder("dinosaurworld:plotvrhroh2")
	public static final Block block = null;
	public Plotvrhroh2Block(DinosaurworldElements instance) {
		super(instance, 24);
	}
