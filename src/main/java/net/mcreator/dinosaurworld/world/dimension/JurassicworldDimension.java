...
public class JurassicworldDimension extends DinosaurworldElements.ModElement {
	@ObjectHolder("dinosaurworld:jurassicworld")
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("jurassicworld"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("dinosaurworld:jurassicworld")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("dinosaurworld:jurassicworld"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("dinosaurworld:jurassicworld"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("dinosaurworld:cycadbiom")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("ocean")), ForgeRegistries.BIOMES.getValue(new ResourceLocation("plains")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("desert")), ForgeRegistries.BIOMES.getValue(new ResourceLocation("mountains")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("forest")), ForgeRegistries.BIOMES.getValue(new ResourceLocation("taiga")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("swamp")), ForgeRegistries.BIOMES.getValue(new ResourceLocation("river")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("nether")), ForgeRegistries.BIOMES.getValue(new ResourceLocation("the_end")),
