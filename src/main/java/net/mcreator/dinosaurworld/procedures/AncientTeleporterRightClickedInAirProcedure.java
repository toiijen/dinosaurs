...
public class AncientTeleporterRightClickedInAirProcedure extends DinosaurworldElements.ModElement {
	public AncientTeleporterRightClickedInAirProcedure(DinosaurworldElements instance) {
		super(instance, 27);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (((entity.dimension.getId()) == (MesozoicDimension.type.getId()))) {
			...
			}
			{
				...
				if (mcserv != null)
					mcserv.getPlayerList().sendMessage(new StringTextComponent("I warned you"));
			}
		} else if (((entity.dimension.getId()) == (1))) {
			if (!entity.world.isRemote && entity instanceof ServerPlayerEntity) {
				DimensionType destinationType = DimensionType.THE_END;
